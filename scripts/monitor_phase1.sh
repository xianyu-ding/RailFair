#!/bin/bash
# Monitor Phase 1 collection progress in real-time
# Usage: ./monitor_phase1.sh [refresh_interval_seconds]
...
if [ -z "$PID_FILE" ] || [ ! -f "$PID_FILE" ]; then
    echo "❌ No Phase 1 process found. Start with: ./run_phase1_background.sh"
    exit 1
fi
...
echo "📊 Phase 1 Collection Monitor (Refresh: ${REFRESH_INTERVAL}s)"
...
while true; do
    clear
    echo "═══════════════════════════════════════════════════════════"
    echo "📊 Phase 1 Batch Collection Monitor"
    echo "═══════════════════════════════════════════════════════════"
    echo ""
