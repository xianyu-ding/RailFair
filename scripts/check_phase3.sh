#!/bin/bash
# Check status of Phase 3 batch collection
# Usage: ./check_phase3.sh [pid_file]
...
if [ -z "$PID_FILE" ] || [ ! -f "$PID_FILE" ]; then
    ...
    echo ""
    echo "💡 To start Phase 3 collection:"
    echo "   ./run_phase3_background.sh"
    exit 1
fi
...
echo "📊 Phase 3 Batch Collection Status"
echo "==================================="
echo "PID: $PID"
